    ...
    <footer className="bg-gray-900 text-gray-300" role="contentinfo">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-white text-lg font-bold mb-4">NovaMart</h3>
            <p className="text-sm">
              Your destination for quality products at great prices. Fast shipping, easy returns, and outstanding customer service.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/products?category=Home+%26+Kitchen" className="hover:text-white transition-colors">Home & Kitchen</Link></li>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm">&copy; 2026 NovaMart. All rights reserved.</p>
